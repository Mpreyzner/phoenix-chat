defmodule Bussy.Presence do
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Bussy.MyChannel do
        use Bussy.Web, :channel
        alias Bussy.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :bussy,
                        pubsub_server: Bussy.PubSub
end
